...
| AI Interactive Map (assistant) | **In Progress (Draft PR chain — DARK)** | Phase 6 chain 6A→6E under X1–X12; deterministic-only (no AI SDK/model/endpoint); see the Phase 6 rows below + `PLATFORM-PHASE-6-PROGRAMME.md` |
