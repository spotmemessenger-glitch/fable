...
| # | Step | State |
|---|---|---|
| 1 | Smart Nearby Discovery Map | Implemented (Draft PRs), dark — Platform Phase 2 stacked PRs #80–#84 + the 2F group (branch `feat/platform-phase-2f-fences-perf-ops-docs`); PR #60 remains the byte-identical earlier draft, reusable concepts re-cut per the Phase 0 classification |
