...
### Platform migration Phase 1 (026–027 — PROPOSED, owner decision pending)
Drafted in the staged programme (group 1E, `feat/platform-phase-1e-ai-and-adrs`); not yet accepted, nothing wired in.
...
| [027](027-mobile-native-boundary.md) | Mobile-native boundary — React Native + native modules target (camera/AR, calls, Bluetooth, background location); Capacitor transitional | Proposed |
