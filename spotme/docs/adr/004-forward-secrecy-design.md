...
**Companions**, all design-only — none of them is a decision to build:

- `004a-e2e-v3-envelope-schema.md` — wire format, canonical serialization,
  negotiation, downgrade rules, prekey-message and replay handling, legacy
  compatibility, test plan. Framing/AAD/KDF vectors regenerated by
  `004a-e2e-v3-vectors.mjs`.
- `004b-e2e-v3-vector-package.md` — the ratchet conformance vectors, generated
  by `004b-e2e-v3-ratchet-vectors.py` and committed as
  `004b-e2e-v3-ratchet-vectors.json`.
- `004c-e2e-v3-decision-package.md` — the five open questions with options,
  recommendations and reversibility, plus the reference-implementation
  selection.

**This ADR's central question — own a ratchet, or defer forward secrecy and
close Priority 1 at ADR-003 — remains open and is the owner's to answer.**
